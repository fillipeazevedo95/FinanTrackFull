-- SOLUÇÃO DEFINITIVA PARA USER_PROFILES
...
-- Remover triggers e funções (exceto update_updated_at_column que é usada por outras tabelas)
...
-- Função para atualizar timestamp (criar apenas se não existir)
